...
interface appStoreState {
    ...
    settings: {
        ...
        updateOperation: (operation: operation, property: operationSettingsKey, newValue: operationSettings[operationSettingsKey] ) => void
    },
    score: number
}

const useAppStore = create<appStoreState>()(immer((set) => ({
    appState: "settings",
    updateAppState: (newAppState) => set((state) => { state.appState = newAppState }),
    settings: {
        ...
        timeLimit: 30,
        updateTimeLimit: (newTime: 30 | 60 | 90| 120) => set(appState => ({ 
            ...appState,
            settings: {
                ...appState.settings,
                timeLimit: newTime
